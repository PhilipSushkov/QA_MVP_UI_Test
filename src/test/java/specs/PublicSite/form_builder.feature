Feature: I can fill out a FormBuilder form
  ...
  Scenario: An incorrect Captcha is rejected
    When I fill in First Name, Last Name, and Comments fields
      And I enter an incorrect Captcha code
      And I click "Submit"
    Then the Captcha code field is marked with the phrase "Validation Code is invalid."
      And the rest of the form remains unchanged